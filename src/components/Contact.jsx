...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-gradient-to-br from-brick via-brick-deep to-brick-dark py-24 md:py-32"
    >
      {/* Background Glow */}
          ...
          <div>
            ...
            <Reveal delay={0.16}>
              <p className="mt-6 text-base md:text-lg text-[#ffd9cd]/85 leading-relaxed max-w-lg">
                ...
                especially where full-stack meets AI. Reach out and I'll get
                back within a day.
              </p>
            </Reveal>
                ...
                <Reveal key={label} delay={0.1 + i * 0.07}>
                  <Tag
                    ...
                    className={`block rounded-2xl bg-ink/25 backdrop-blur border border-cream/15 p-6 h-full transition-all duration-300 ${
                      href
                        ? 'hover:border-cream/40 hover:bg-ink/40 hover:-translate-y-1'
                        : ''
                    }`}
                  >
                    ...
                    <p className="text-xs uppercase tracking-widest text-[#ffc9b8]/80">
                      {label}
                    </p>

                    <p className="mt-1 font-medium text-cream break-all">
                      {value}
                    </p>
                  </Tag>
                </Reveal>
